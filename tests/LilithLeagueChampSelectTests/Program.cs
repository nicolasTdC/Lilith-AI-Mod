...
Assert(ScreenLook.ShouldCapture("Olha a minha tela. Vê se consegue enxergar."),
    "Olha a minha tela captures.");
...
Console.WriteLine("Lilith screen-look tests passed (19 assertions).");
